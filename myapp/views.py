...
def init(request):
    return render(request, 'myapp/init.html')
...
def add_product(request):
    ...
    return render(request, 'myapp/product_add.html', {'form': form, 'message': message, 'title': 'Добавить продукт'})
...
def update_product(request):
    ...
    return render(request, 'myapp/product_add.html', {'form': form, 'message': message, 'title': 'Обновить продукт'})
